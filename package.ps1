...
try {
    ...
    # Test are disabled because container need real aws key to work
    ...
    #     start_time=1537736400547;
    #     end_time=1537746610547; filter="ERROR"
    # }
    # Invoke-WebRequest -Uri "http://$($dockerMachineIp):8080/v1/cloudwatch/get_aws_logs" -Method POST -Body $postParams
